...
bind --mode default -k nul __fzf_reverse_isearch
bind --mode insert -k nul __fzf_reverse_isearch


function __fzf_cd_with_history
    set -l dir (
        fd --type d . $HOME/Work | fzf --height 40% --reverse --preview 'tree -C {} | head -100'
    )
...
# Bind it to Shift+Space
bind \cZ '__fzf_cd_with_history'
bind -M insert \cZ '__fzf_cd_with_history'
